    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-6 font-sans">
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-2xl border border-slate-100 shadow-xl">
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Junte-se à Ágora</h1>
          <p className="text-slate-500 text-sm mt-2 px-4">
            A rede exclusiva para estudantes. Use seu e-mail institucional para se conectar. <br /> 
            <span className="text-red-600">Atualmente limitado a UFSJ.</span>
          </p>
        </div>
        ...
        <div className="mt-6 bg-slate-50 p-4 rounded-lg flex items-start gap-3 border border-slate-100">
          <ShieldCheck className="text-indigo-600 shrink-0 mt-0.5" size={18} />
          <p className="text-xs text-slate-500 leading-relaxed">
            Nós não publicamos nada sem sua permissão. Seus dados acadêmicos estão seguros e visíveis apenas para a comunidade.
          </p>
        </div>
